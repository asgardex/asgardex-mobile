...
import { ClientLedger, defaultClientConfig } from '@xchainjs/xchain-mayachain'
 ...
 * Note: As long as Ledger MAYA app has not been updated, amino encoding/decoding is still used.
 * That's why txs are still broadcasted to `txs` endpoint, which is still supported by MayaChain.
 */
