...
import BondsIcon from '../../assets/svg/icon-bonds.svg'
import SettingsIcon from '../../assets/svg/icon-cog.svg'
import PoolIcon from '../../assets/svg/icon-pools.svg'
import PortfolioIcon from '../../assets/svg/icon-portfolio.svg'
import SwapIcon from '../../assets/svg/icon-swap.svg'
import WalletIcon from '../../assets/svg/icon-wallet.svg'
import ThorChainIcon from '../../assets/svg/logo-thorchain.svg'
