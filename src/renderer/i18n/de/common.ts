...
const common: CommonMessages = {
  ...
  'common.mayanameError': 'MAYAName nicht verfügbar',
  'common.mayanameRegistrationSpecifics':
    'MAYANames ermöglichen jedem, Cross-Chain-Wallet-Adressen mit einer Zeichenkette von 1-30 hexadezimalen Zeichen, einschließlich Sonderzeichen -+. MAYANames sind auf 30 Zeichen begrenzt, einschließlich ^[a-zA-Z0-9+-]+$.',
  ...
  'common.isUpdateThorname': 'THORName aktualisieren',
  'common.isUpdateMayaname': 'MAYAName aktualisieren',
  ...
  'common.memo': 'Memo',
  'common.memos': 'Memos',
  'common.destinationTag': 'Ziel-Tag',
  'common.destinationTag.placeholder': 'Optionales Ziel-Tag',
  'common.destinationTag.required.placeholder': 'Erforderliches Ziel-Tag',
  ...
  'common.transaction.tracking': 'Transaktionen verfolgen',
  'common.transaction.loading': 'Transaktionen werden geladen...',
  'common.transaction.failed': 'Fehler beim Laden der Transaktionen',
  'common.transaction.active': 'Aktiv',
  'common.transaction.completed': 'Abgeschlossen',
  'common.fee': 'Gebühr',
  ...
  'common.fetchFromLedger': 'Von Ledger abrufen',
