...
const common: CommonMessages = {
  ...
  'common.mayanameError': 'MAYAnombre no disponible',
  'common.mayanameRegistrationSpecifics':
    'Los MAYANombres permiten a cualquiera registrar direcciones de monedero de cadena cruzada a una cadena larga de 1-30 caracteres hexadecimales que incluyen caracteres especiales -_+. Los MAYANames están limitados a 30 caracteres, incluyendo ^[a-zA-Z0-9+_-]+$.',
  ...
  'common.isUpdateThorname': 'Actualización THORNombre',
  'common.isUpdateMayaname': 'Actualización MAYANombre',
  ...
  'common.memo': 'Memo',
  'common.memos': 'Memos',
  'common.destinationTag': 'Etiqueta de Destino',
  'common.destinationTag.placeholder': 'Etiqueta de destino opcional',
  'common.destinationTag.required.placeholder': 'Etiqueta de destino requerida',
  'common.date': 'Fecha',
  ...
  'common.transaction.tracking': 'Seguimiento de transacciones',
  'common.transaction.loading': 'Cargando transacciones...',
  'common.transaction.failed': 'Error al cargar transacciones',
  'common.transaction.active': 'Activas',
  'common.transaction.completed': 'Completadas',
  'common.fee': 'Tasa',
  ...
  'common.tx.loadingSecondTx': 'Cargando parámetros de la segunda transacción',
  ...
  'common.tx.type.runePoolWithdraw': 'Retiro de RunePool',
  ...
  'common.fetchFromLedger': 'Obtener de Ledger',
  'common.nativeSegwit': 'Native Segwit',
  'common.taproot': 'Taproot',
  'common.protocols': 'Protocolos',
  'common.resetToDefault': 'Restablecer al valor por defecto',
