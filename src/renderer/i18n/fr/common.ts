...
const common: CommonMessages = {
  ...
  'common.mayanameError': 'MAYAName non disponible',
  'common.mayanameRegistrationSpecifics': `Les MAYANames permettent à quiconque d'enregistrer des adresses de portefeuille inter-chaînes sous forme d'une chaîne de 1 à 30 caractères hexadécimaux, y compris les caractères spéciaux -+. Les MAYANames sont limités à 30 caractères, y compris ^[a-zA-Z0-9+-]+$.`,
  ...
  'common.isUpdateThorname': 'Mettre à jour le nom THOR',
  'common.isUpdateMayaname': 'Mettre à jour le nom MAYA',
  ...
  'common.memo': 'Mémo',
  'common.memos': 'Mémos',
  'common.destinationTag': 'Étiquette de Destination',
  'common.destinationTag.placeholder': 'Étiquette de destination optionnelle',
  'common.destinationTag.required.placeholder': 'Étiquette de destination requise',
  'common.date': 'Date',
  ...
  'common.transaction.tracking': 'Suivi des transactions',
  'common.transaction.loading': 'Chargement des transactions...',
  'common.transaction.failed': 'Échec du chargement des transactions',
  'common.transaction.active': 'Actives',
  'common.transaction.completed': 'Terminées',
  'common.fee': 'Frais',
