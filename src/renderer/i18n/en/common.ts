...
const common: CommonMessages = {
  ...
  'common.mayanameError': 'MAYAName not available',
  'common.mayanameRegistrationSpecifics':
    'MAYANames allow anyone to register cross-chain wallet addresses to a 1-30 long string of hexadecimal characters which include special characters -_+. MAYANames are limited to 30 characters, including ^[a-zA-Z0-9+_-]+$',
  'common.owner': 'Owner',
  ...
  'common.memo': 'Memo',
  'common.memos': 'Memos',
  'common.destinationTag': 'Destination Tag',
  'common.destinationTag.placeholder': 'Optional destination tag',
  'common.destinationTag.required.placeholder': 'Required destination tag',
  'common.date': 'Date',
  ...
  'common.transaction.tracking': 'Tracking Transactions',
  'common.transaction.loading': 'Loading transactions...',
  'common.transaction.failed': 'Failed to load transactions',
  'common.transaction.active': 'Active',
  'common.transaction.completed': 'Completed',
  'common.fee': 'Fee',
