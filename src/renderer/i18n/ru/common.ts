...
const common: CommonMessages = {
  ...
  'common.mayanameError': 'MAYAName недоступен',
  'common.mayanameRegistrationSpecifics':
    'MAYANames позволяют каждому зарегистрировать кросс-цепочечные адреса кошельков с использованием строки из 1-30 шестнадцатеричных символов, включая специальные символы -+. MAYANames ограничены 30 символами, включая ^[a-zA-Z0-9+-]+$.',
  ...
  'common.memo': 'Мемо',
  'common.memos': 'Мемо',
  'common.destinationTag': 'Целевая метка',
  'common.destinationTag.placeholder': 'Дополнительная целевая метка',
  'common.destinationTag.required.placeholder': 'Обязательная целевая метка',
  'common.date': 'Дата',
  ...
  'common.streaming.time': 'Потоковый',
  'common.streaming.time.info': 'Оценочное время для завершения этого потокового обмена',
