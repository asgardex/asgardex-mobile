...
import { Address, AnyAsset, AssetAmount, assetToString, BaseAmount, Chain } from '@xchainjs/xchain-util'
import BigNumber from 'bignumber.js'
import { array as A } from 'fp-ts'
import { boolean as B } from 'fp-ts'
import { eq as Eq } from 'fp-ts'
import { number as N } from 'fp-ts'
import { option as O } from 'fp-ts'
import { string as S } from 'fp-ts'

import { ApiUrls, KeystoreId, LedgerError } from '../../../shared/api/types'
...
export const eqAsset: Eq.Eq<AnyAsset> = {
